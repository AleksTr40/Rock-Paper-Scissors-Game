...
#When you have a draw.
    ...
    if player == robot:
        ...
        print("Rules are simple, solve the problem in short period of time and get a point, if you dont then the Computer gets a point.")
...
#Secret Thingy 😉
    if robot_score == 2 and not hint_shown:
        print("Psst... there's a secret option called 'shotgun'... Try it! But be careful, you can only use it once!")
        hint_shown = True
